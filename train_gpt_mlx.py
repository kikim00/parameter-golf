...
class Hyperparameters:
    ...
    # Optional local-iteration knob to cap the validation token stream. Keep at
    # 0 for the canonical full fixed validation split used by challenge runs.
...
def main() -> None:
    ...
    if args.val_max_tokens > 0:
        log(f"WARNING: val_loader:subset val_max_tokens:{args.val_max_tokens}")
